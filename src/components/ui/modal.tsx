...
const ModalRoot = ({ children, ...props }: RootProps) => {
  ...
  return (
    <ModalContext.Provider value={{ isDesktop: !isMobile }}>
  ...
  return (
    <div
      className={cn(
        ...
        isDesktop && "max-h-[75dvh] xl:max-h-[80dvh]",
        className
      )}
      {...props}
    >
      <div
        className={cn(
          " flex-1 overflow-auto px-4 pt-2 pb-4",
          shadow && "faded-bottom pb-8",
          bodyClassName
        )}
      >
        {children}
...
export const Modal = {
  ...
  Body: ModalBody,
  Footer: ModalFooter,
  Actions: ModalActions, // optional ready-made footer
};
