      ...
      >
        ...
        <div tw="flex absolute flex-row bottom-24 right-24 text-white">
          ...
          >
            ...
            <g clipPath="url(#d5dae3eaf6)">
              <g clipPath="url(#c919d3bb22)">
                <g clipPath="url(#e6764ad57b)">
                  <g clipPath="url(#d89bfe6f6b)">
                    <path
                      fill="#7b7979"
            ...
            <g clipPath="url(#51147463ee)">
              <g clipPath="url(#612d249f4f)">
                <g clipPath="url(#287751f571)">
                  <g clipPath="url(#85a88e4923)">
                    <path
                      fill="#444142"
            ...
            <g clipPath="url(#28af9eddc3)">
              <g clipPath="url(#3f45c01d72)">
                <g clipPath="url(#d7bd9f5f69)">
                  <g clipPath="url(#7b0cb3d72d)">
                    <path
                      fill="#ed1c24"
            ...
            <g clipPath="url(#97e932ff7f)">
              <g clipPath="url(#cb314ac215)">
                <g clipPath="url(#084771be65)">
                  <g clipPath="url(#ff9b85ada5)">
                    <path
                      fill="#ac1929"
